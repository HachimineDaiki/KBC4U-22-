...
void PlanetInit() {
	...
	planet[0].pos = VGet(-170, 0, 50000+384400);//月
	planet[1].pos = VGet(-150, 0, 149600000-108200000);//金星
	planet[2].pos = VGet(-150, 0, 149600000-57910000);//水星
	planet[3].pos = VGet(-150, 0, 50000+149600000);//太陽
