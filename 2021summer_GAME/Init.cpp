...
void PlanetInit() {
	planet[0].radius = 34740;//月
	planet[1].radius = 121040;//金星
	planet[2].radius = 48790;//水星
	...
	//1000万以内に収める
	planet[0].pos = VGet(-170, 77000, 50000 + 3844000);//月
	planet[1].pos = VGet(-150, 1632005, 14960000 - 10820000);//金星
	planet[2].pos = VGet(-150, 3717395, 14960000 - 5791000);//水星
	planet[3].pos = VGet(-150, 6003214, 14960000);//太陽
